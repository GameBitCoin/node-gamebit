...
![Gameunits](http://i.imgur.com/urszuzh.png)
...
You'll need a running instance of [gameunitsd](https://github.com/gameunits/gameunits) to connect with.
...
All [Gameunits API](https://litecoin.info/Litecoin_API) commands are supported, in lowercase or camelcase form.
...
<td> <b>Currently only available on testnet</b> Add a nrequired-to-sign multisignature address to the wallet. Each key is a gameunits address or hex-encoded public key. If [account] is specified, assign address to [account]. </td>
<td> N
</td></tr>
<tr>
<td> backupwallet </td>
...
<tr>
<td> dumpprivkey </td>
<td> [gameunitsaddress] </td>
<td> Reveals the private key corresponding to <gameunitsaddress< </td>
<td> Y
</td></tr>
<tr>
<td> encryptwallet </td>
...
<td> [account] </td>
<td> Returns the current gameunits address for receiving payments to this account. </td>
<td> N
</td></tr>
<tr>
...
<td> getgenerate </td>
<td> </td>
<td> Returns true or false whether gameunitsd is currently generating hashes </td>
<td> N
</td></tr>
<tr>
...
<td> getnewaddress </td>
<td> [account] </td>
<td> Returns a new gameunits address for receiving payments.  If [account] is specified (recommended), it is added to the address book so payments received with the address will be credited to [account]. </td>
<td> N
</td></tr>
<tr>
...
<td> [gameunitsaddress] [minconf=1] </td>
<td> Returns the total amount received by <gameunitsaddress< in transactions with at least [minconf] confirmations. While some might consider this obvious, value reported by this only considers *receiving* transactions. It does not check payments that have been made *from* this address. In other words, this is not "getaddressbalance". Works only for addresses in the local wallet, external addresses will always show 0. </td>
<td> N
</td></tr>
<tr>
...
<p>To get a list of accounts on the system, execute gameunitsd listreceivedbyaddress 0 true
</p>
</td>
<td> N
</td></tr>
...
<tr>
<td> sendfrom </td>
<td> [fromaccount] [togameunitsaddress] [amount] [minconf=1] [comment] [comment-to] </td>
...
<tr>
<td> signmessage </td>
<td> [gameunitsaddress] [message] </td>
...
<td> stop </td>
<td> </td>
<td> Stop gameunits server. </td>
<td> N
</td></tr>
<tr>
<td> validateaddress </td>
<td> [gameunitsaddress] </td>
<td> Return information about [gameunitsaddress]. </td>
<td> N
</td></tr>
<tr>
<td> verifymessage </td>
<td> [gameunitsaddress] [signature] [message] </td>
